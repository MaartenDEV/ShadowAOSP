...
import com.maartenxda.shadowaosp.dummy.DummyContent;
...
public class SectionListFragment extends ListFragment {
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		if (position == 1) {
			...
			Intent intent = new Intent(getActivity(), Skins.class);
			startActivity(intent);
		...
		if (position == 3) {
			...
			Intent intent = new Intent(getActivity(), RosiePreferences.class);
			startActivity(intent);
